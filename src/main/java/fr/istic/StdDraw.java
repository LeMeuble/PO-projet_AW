 ...
 * {@code StdDraw.arc(0.0, 0.0, 1.0, 0, 90)} draws the arc of the fr.istic.unit circle
 ...
 * places in the fr.istic.unit square, with (0, 0) at lower left and (1, 1) at upper
 ...
 * Save</em> fr.istic.menu option. You can also save a file programatically using the
 * following method:
 * <ul>
 ...
 * (the fr.istic.unit square, by default). You should use these methods in an animation
...
//		frame.setJMenuBar(createMenuBar());
    ...
    // create the fr.istic.menu bar (changed to private)
